...
{
    public class ApprovalManager : IInitializable, IDisposable
    {
            ...
            NetworkManager.ConnectionApprovalResponse res)
        {
            ...
            {
                res.Reason = "The room is already full.";
                return;
            }
            ...
            if (!_roomStatus.IsRoomScene) // [추가] 스테이지 시작된 룸인 경우
            {
                res.Reason = "The room is already started";
                return;
            }
