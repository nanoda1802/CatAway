...
namespace _Scripts.Scene_Room
{
    public class PointSwapper : IInitializable, IDisposable
    {
        ...
        // private readonly LayerMask _playerMask = LayerMask.NameToLayer("Player");
        ...
        private void OnPressCanceled(InputAction.CallbackContext ctx)
        {
            ...
            Debug.Log($"<color=green>[Swap]</color> PointSwapper OnPressCanceled");
        ...
        private void OnPosPerformed(InputAction.CallbackContext ctx)
        {
            ...
            Debug.Log($"<color=green>[Swap]</color> PointSwapper OnPosPerformed : mem : {_draggingMem != null}");
