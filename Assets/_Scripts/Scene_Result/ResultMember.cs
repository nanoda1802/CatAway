...
namespace _Scripts.Scene_Result
{
    public class ResultMember : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (IsServer)
            {
                _roomStatus.Report("OnSpawn ResultMember");
        ...
        protected override void OnNetworkPostSpawn()
        {
            ...
            _avatarData.ChangeAvatar(_renderer, _matPropBlock, AvatarIndex); // 여기도 명시적으로 한 번 바꿔주기
        ...
        // [Rpc(SendTo.Everyone)]
        // private void ShowCardRpc(Team team, FixedString32Bytes nickname, ulong aceId)
        // {
        //     var msg = new ShowResultMemberCardMessage(
        //         this.OwnerClientId,
        //         team,
